...
class LectureController extends PageController
{
	...
	public function index(Request $request)
	{
		...
		return view('lectures', compact('items', 'categories', 'currentCategory', 'footer_pages'));
	}
	...
	public function applyItem(Request $request)
	{
		...
		return view('applyLec', compact('items', 'categories', 'accept', 'footer_pages'));
	}
...
//
		...
		return back()->with('message', 'Файлы были загружены. Они появятся в лекциях после прохождения модерации.');
	}
}
