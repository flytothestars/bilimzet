...
class CourseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'course.form_training' => ['required'],
            'course.form_training_kz' => ['required'],
            'course.valid_period' => ['required'],
            'course.valid_period_kz' => ['required'],
            'course.issuance_certificate' => ['required'],
            'course.issuance_certificate_kz' => ['required'],
            'course.certificate_text' => ['required'],
            'course.certificate_text_kz' => ['required'],
