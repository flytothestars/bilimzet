<?php $__env->startSection('content'); ?>
					...
					<form action="/create_new_payment.php" method="POST" id="add_funds" target="_blank">
						...
						<table>
							<tr>
								...
								<td width="5"></td>
								<td><button type="submit" class="btn black"><?php echo app('translator')->get('profile.fill'); ?></button></td>
							</tr>
						</table>
					</form>
				</div>
	...
	<div class="lk between align-top centered width1088 olympic-results">
		...
		<div class="inner">
			<?php $__empty_1 = true; $__currentLoopData = $olympicResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $olympicResult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
			<div class="card">
				<div class="card-body">
					<a href="<?php echo e(route('olympic.show.result', $olympicResult->id)); ?>"><h5 class="card-title"><?php echo e($olympicResult->course->title); ?></h5></a>
				</div>
			</div>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/profile.blade.php ENDPATH**/ ?>