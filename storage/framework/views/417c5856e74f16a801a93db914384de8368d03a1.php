...
<head>
	...
	<script>
        window.default_locale = "<?php echo e(app()->getLocale()); ?>";
	</script>
</head>
<body>
	<div class="wrapper">
					...
					<div class="left flex end align-center">
						...
						<?php if(auth()->guard()->check()): ?>
							<div class="login" style="margin-left: 10px">
								...
								<?php if(!isset(auth()->user()->status_lector)): ?> <a href="<?php echo e(route('seminar')); ?>" class="btn shine-button draw-border"><p>Семинар</p></a> <?php endif; ?>
							</div>
							<div class="notification notify">
								<a href="<?php echo e(route('notifications')); ?>"><img src="/images/elements/notification.svg" alt=""></a>
							</div>
						...
						<?php if(auth()->guard()->guest()): ?>
							...
							<div style="margin-left: 10px;">
								<a href="<?php echo e(route('seminar')); ?>" class="btn shine-button draw-border">
									<p>Семинар</p>
								</a>
							</div>
						<?php endif; ?>
...
<?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/layouts/base.blade.php ENDPATH**/ ?>