<?php $__env->startSection('content'); ?>
    ...
    <h2 class="mt-4 mb-3">Редактировать лекцию</h2>
    <div>
        <form id="form" method="post" enctype="multipart/form-data"
              action="<?php echo e(route('admin.updateLecturesItem', ['id' => $item->id])); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/admin/lecturesItem.blade.php ENDPATH**/ ?>