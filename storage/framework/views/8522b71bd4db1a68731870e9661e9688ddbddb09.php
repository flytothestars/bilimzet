<?php $__env->startSection('content'); ?>
	...
	<div class="podacha-statyi width1088">
		...
		<div class="my-articles width1088">
			<form id="form" method="post" enctype="multipart/form-data" action="<?php echo e(route('doApplyLecItem')); ?>">
				<?php echo csrf_field(); ?>
				<?php if($errors->any()): ?>
				...
				<?php endif; ?>
				<div class="row">
					<label><?php echo app('translator')->get('common.lection_name'); ?> ru</label>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="row">
					<label><?php echo app('translator')->get('common.lection_name'); ?> kz</label>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="row flex between  align-center desc">
					<div class="left">
						<label><?php echo app('translator')->get('common.lection_description'); ?> ru</label>
...
unset($__errorArgs, $__bag); ?>
						...
						<label><?php echo app('translator')->get('common.lection_description'); ?> kz</label>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="align-right">
					<button type="submit" class="btn blue"><?php echo app('translator')->get('common.send_lection'); ?></button>
				</div>
			</form>
			<?php if($items): ?>
				<div class="articles-listing">
					<div class="top flex between align-center">
						<div class="left"><?php echo app('translator')->get('common.lection_name'); ?></div>
					...
					<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="row flex between align-center <?php echo e($item->is_published ?  'published' : 'unpublished'); ?> ">
							<div class="left"><a href="<?php echo e(route('showLectureItem', ['id' => $item->id ])); ?>"><?php echo e($item->title); ?></a></div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/applyLec.blade.php ENDPATH**/ ?>