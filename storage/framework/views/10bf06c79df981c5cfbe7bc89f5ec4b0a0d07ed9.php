<div class="inner-menu centered width1088">
	<ul>
		...
		<li class="<?php echo e(Route::currentRouteName() === 'applyLectureItem' ? 'active' : ''); ?>">
			<a href="<?php echo e(route('applyLectureItem')); ?>">Мои лекции</a>
		</li>
...
<?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/parts/profileMenu.blade.php ENDPATH**/ ?>