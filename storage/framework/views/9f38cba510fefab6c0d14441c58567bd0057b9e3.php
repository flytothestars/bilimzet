...
unset($__errorArgs, $__bag); ?>
			...
			<div class="cert" style="line-height:1;">
				...
				<div class="name-wrap">
					...
					<input type="text" id="name-inp" class="name-inp" value="<?php echo e($item->fio ?? old('fio')); ?>" name="fio" id="fio">
				...
				<div class="accept-wrap">
					...
					<input type="text" id="accept-inp" class="accept-inp" value="<?php echo e($item->title ?? old('title')); ?>" name="title" id="title">
					<div class="accept-hint">
						прошел(ла) курс повышения квалификации на тему / тақырыбында
					</div>
				</div>
				<div class="clock-wrap">
					<input type="text" class="clock-inp" id="clock-inp" value="<?php echo e($item->duration ?? old('duration')); ?>" name="duration" id="duration">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/admin/certificate.blade.php ENDPATH**/ ?>