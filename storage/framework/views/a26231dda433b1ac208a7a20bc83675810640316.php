<?php $__env->startSection('content'); ?>
	...
	<div>
		<form id="form" method="post" action="<?php echo e(route(($certId ? 'admin.updateCertificate' : 'admin.storeCertificate'), [ 'id' => $id, 'certId' => $certId ])); ?>" enctype="multipart/form-data">
			<?php echo csrf_field(); ?>
			<?php if($errors->any()): ?>
			...
			<div class="form-group">
				...
				<input value="<?php echo e($item->course_title ?? old('course_title')); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
				<div class="invalid-feedback">
					<?php echo e($errors->first('course_title')); ?>
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="cert" style="line-height:1;">
				...
				<div class="name-wrap">
					...
					<input type="text" id="name-inp" class="name-inp" value="<?php echo e($item->fio ?? old('fio')); ?>"
				...
				<div class="accept-wrap">
					<div class="accept-lab">
						Данный сертификат подтверждает, что
					</div>
					<input type="text" id="accept-inp" class="accept-inp" value="<?php echo e($item->title ?? old('title')); ?>"
				...
				<div class="clock-wrap">
					<input type="text" class="clock-inp" id="clock-inp" value="<?php echo e($item->duration ?? old('duration')); ?>"
				...
				<div class="foot">
					<div class="foot-date">
						...
						<div class="foot-wrap">
					<span>“<input type="text" id="foot-inp" value="<?php echo e($item->day ?? old('day')); ?>"
									  name="day" id="day" class="foot-inp foot-inp_d">”</span>
							<input type="text" id="foot-inp" alue="<?php echo e($item->month ?? old('month')); ?>"
									 name="month" id="month" class="foot-inp foot-inp_m">
							<div class="foot-year">2020 ж/г</div>
						</div>
					</div>
					<div class="foot-mo">
						М.О.
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\kcppk.loc\resources\views/admin/certificate.blade.php ENDPATH**/ ?>