    ...
    <div class="login flex between align-top width1088 shadow">
        <div class="right" style="flex-basis: 100%;">
			...
			<div style="width: 900px;">
                <div class="title"><?php echo app('translator')->get('buy.title'); ?></div>
                ...
                <?php endif; ?>
                <p><a href="<?php echo e(route('course', [ 'id' => $item->course_id ])); ?>"><?php echo app('translator')->get('buy.back'); ?></a></p>
                <p><?php echo app('translator')->get('buy.gotta'); ?> <b>"<?php echo e($item->course->title); ?>".</b></p>
                ...
                <form id="buyCourseForm" method="post">
                    ...
                    <?php if($item->price_kzt <= $availableMoneyKZT): ?>
                        <a class="buy" href="#"
                           onclick="document.getElementById('buyCourseForm').submit(); return false;"><b><?php echo app('translator')->get('buy.buy'); ?></b></a>
                    <?php else: ?>
                        <br>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kcppk.kz/httpdocs/resources/views/buyCoursePart.blade.php ENDPATH**/ ?>