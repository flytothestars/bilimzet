<ul class="menu flex between align-center">
	...
	<li>
		<a class="<?php echo e(Route::currentRouteName() === 'contacts' ? 'active' : ''); ?>" href="<?php echo e(route('contacts')); ?>"><?php echo app('translator')->get('menu.contacts'); ?></a>
	</li>
</ul>
<?php /**PATH D:\OpenServer\domains\kcppk.loc\resources\views/parts/menu.blade.php ENDPATH**/ ?>