...
@section('content')
	...
	<div class="podacha-statyi width1088">
		<div class="width1088 page-title">
			<h1>@lang('common.push_article')</h1>
		</div>
		<div class="my-articles width1088">
			<form id="form" method="post" enctype="multipart/form-data" action="{{ route('doApplyItem') }}">
				@csrf
				@if ($errors->any())
				...
				@endif
				<div class="row">
					<label>@lang('common.article_name') ru</label>
				...
				<div class="row">
					<label>@lang('common.article_name') kz</label>
				...
				<div class="row flex between  align-center desc">
					<div class="left">
						<label>@lang('common.article_description') ru</label>
						...
						<label>@lang('common.article_description') kz</label>
				...
				<div class="align-right">
					<button type="submit" class="btn blue">@lang('common.send_article')</button>
				</div>
			</form>
			@if ($items)
				<div class="articles-listing">
					<div class="top flex between align-center">
						<div class="left">@lang('common.article_name')</div>
					...
					@foreach ($items as $item)
						<div class="row flex between align-center {{ $item->is_published ?  'published' : 'unpublished'}} ">
							<div class="left"><a href="{{ route('showLibraryItem', ['id' => $item->id ]) }}">{{ $item->title }}</a></div>
