...
@section('content')
						...
						<div class="slide swiper-slide">
							<div class="slide-body" style="background:url('/images/slider/slide1.svg') no-repeat;">
								<div class="text-block">
									...
									<div class="title">@lang('home.title1')</div>
									<div class="text">@lang('home.text1')</div>
								</div>
						...
						<div class="slide swiper-slide">
							<div class="slide-body" style="background:url(/images/slider/slide2.svg) no-repeat;">
								<div class="text-block">
									...
									<div class="title">@lang('home.title2')</div>
									<div class="text">@lang('home.text2')</div>
								</div>
						...
						<div class="slide swiper-slide">
							<div class="slide-body" style="background:url(/images/slider/slide3.svg) no-repeat;">
								<div class="text-block">
									...
									<div class="title title_big">@lang('home.title3')</div>
								</div>
	...
	<div class="news">
		<div class="centered top flex between align-bottom">
			<div class="title">@lang('home.news_events')</div>
			<a href="{{ route('news') }}">@lang('home.news')</a>
		</div>
		<div class="news-row">
			@foreach ($news as $new)
				<div class="news-item">
					<div class="image"><img src="{{ '/uploads/news/' . $new->miniature }}" alt=""></div>
					<div class="date"><img src="images/elements/date.svg" alt=""><span>{{ $new->date }}</span></div>
					<div class="title"><a href="{{ route('newPost', ['id' => $new->id]) }}">{{ $new->name }}</a></div>
					<div class="link"><a href="{{ route('newPost', ['id' => $new->id]) }}">@lang('home.more')</a></div>
				</div>
			@endforeach
		</div>
	</div>
...
{{--		<img src="/images/elements/mouse.svg" alt="">--}}
{{--		<p>@lang('home.mouse')</p>--}}
{{--	</div>--}}
	...
	<div class="company">
		<div class="centered">
			<div class="title-image flex align-center">
				<div class="title">@lang('home.about')</div>
	...
	<div class="steps">
		<div class="width1088">
			<div class="title">@lang('home.steps')</div>
			<ul>
				<li class="item">
	...
	<div class="subjects-block">
		<div class="centered">
			<div class="title">@lang('home.course')</div>
